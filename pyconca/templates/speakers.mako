...
<%block name="info">
    ...
    <div class="row-fluid content-section">
        ...
        <ul>
          ...
          <li>${_(u"""Additional notes for the proposal reviewers. This can include additional background information such as links to other presentations you have done, or links to blog posts, articles, or code related to your presentation.""")}</li>
        </ul>
    </div>
</%block>
