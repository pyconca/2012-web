...
<%block name="info">
    <div class="row-fluid content-section">
      ...
      <p>
        ...
        <ul>
            <li>He tweets: <a href="https://twitter.com/zzzeek">@zzzeek</a></li>
            <li>He codes: <a href="https://bitbucket.org/zzzeek">bitbucket.org/zzzeek</a></li>
            <li>He blogs: <a href="http://techspot.zzzeek.org">techspot.zzzeek.org</a></li>
        <ul>
      </p>
    </div>
    ...
    <div class="row-fluid content-section">
      ...
      <p>
        Chris McDonough is the primary author of the
